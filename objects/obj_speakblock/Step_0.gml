...
&& !instance_exists(obj_textbox) && (!instance_exists(obj_cutscenefade) || (obj_cutscenefade.hold_black && obj_cutscenefade.fade_alpha >= 1) || obj_cutscenefade.fade_color == c_white) && !global.warp_pending && !global.fight_seq_starting && !instance_exists(obj_king_turn_sequencer) && (ignore_facing || _correct_dir)
	{
...
{
if keyboard_check_pressed(ord("Z")) && distance_to_object(obj_kris) < interact_range
&& !instance_exists(obj_textbox) && (!instance_exists(obj_cutscenefade) || (obj_cutscenefade.hold_black && obj_cutscenefade.fade_alpha >= 1) || obj_cutscenefade.fade_color == c_white) && !global.warp_pending && !global.fight_seq_starting && !instance_exists(obj_king_turn_sequencer)
    {
